...
public final class DialogGUI extends GUIWindow {
	...
	public void renderPrimaryContent(GameContainer gc, String content, String[] responses) throws SlickException {
		...
		for (String reply : responses) {
			...
			replyAreas[replyN - 1] = new MouseOverArea(gc, new Image((int) (windowRect.getWidth() - 24 - 64), 18 * lineN), (int) (windowRect.getX() + 12 + 64),
	...
	public void beginDialog(GameContainer gc, GameState game) throws SlickException {
		currentDialog = 0;
		renderPrimaryContent(gc, dialog[0].getPrompt(), dialog[0].getReplyPrompts(game));
	}

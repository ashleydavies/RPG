...
public class WorldMap {
    private final Image iconBackground;
    private final Image iconHoverBackground;
    private final Image iconSelectedBackground;
    private final Image iconUnclearedBackground;
    private final Image iconMapApproach;
    private final Image[] icons;
    private final Image worldMap;
    private final MapIconData[] mapIconData;
    private final MapConnection[] mapConnectors;
